        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-blue-700 to-blue-500 text-white p-6">
            ...
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div>
                <p className="text-[10px] opacity-70">{data.score_label || "Score Destrava"}</p>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="text-[10px] text-slate-400 mt-2">
              Relatório gerado em {fmtDate(data.gerado_em)} por {data.responsavel_analise} · {data.marca_sistema || "Destrava Crédito"}
            </p>
          </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {[
              { label: data.score_label || "Score Destrava", value: `${data.analise_credito?.score_destrava}/100`, color: "text-blue-700" },
