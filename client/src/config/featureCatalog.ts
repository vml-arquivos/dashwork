...
export const FEATURE_CATALOG: FeatureCatalogItem[] = [
  ...
  { key: "personalizacao", group: "gestao", label: "Minha Empresa", href: "/colaborador/personalizacao", description: "Logo, papel timbrado, rodapé, dados institucionais e signatário da conta.", adminOnly: true },
